...
public class AnBProducer {
    private static final String BOOTSTRAP_SERVER_URL = "localhost:9092";
    private static final String SCHEMA_REGISTRY_URL = "http://localhost:8081";
    private static final String TOPIC   = "AnB_input_part_1";
    private static final String KEY = "key1";
    private static long ID = 0;
    private static final int CHUNK_SIZE = 600;
    protected static int NUMBER_OF_CHUNKS = (int) Math.floor( Math.log(CHUNK_SIZE-1) / Math.log(2));
